...
- 修改 [ci.yml 文件的第 7、8 行](https://github.com/fpinglabs/AutoGreen/blob/main/.github/workflows/ci.yml#L7-L8) 去掉前面的 `#` 号
- 修改 [ci.yml 文件的第 23、24 行](https://github.com/fpinglabs/AutoGreen/blob/main/.github/workflows/ci.yml#L19-L20) 为自己的 GitHub 账号和昵称
- (可选) 你可以通过修改 [ci.yml 文件的第 8 行](https://github.com/fpinglabs/AutoGreen/blob/main/.github/workflows/ci.yml#L8)来调整频率
